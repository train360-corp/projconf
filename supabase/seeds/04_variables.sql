...
values ('008D797C-73E8-42BB-9B45-B5F7AD71D60A'::uuid, 'HOST', 'IP address to bind to', 'STATIC', '"127.0.0.1"'),
       ('94AB1156-5B42-499F-B8AA-92CA45DFA180'::uuid, 'HOST', 'IP address to bind to', 'STATIC', '"127.0.0.1"'),
